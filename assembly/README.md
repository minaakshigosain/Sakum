...
| `sakum_tracker_arm64.s` | **ब्रम्ह LIVE HISTORY VIEWER** (native Apple Silicon / AArch64) — the arm64-native port of the tracker above. Identical behavior, no host language. This is what `tools/sakum_tracker.sh` builds on M-series Macs. | `gcc -arch arm64 assembly/sakum_tracker_arm64.s -o /tmp/tracker && /tmp/tracker --live` |
