# sakum_keywords_riscv64.s - Sakum Lang domain keyword registry, RISC-V port.
...
# Build: riscv64-elf-gcc -I assembly -c assembly/sakum_keywords_riscv64.s -o /tmp/kw.o

    .text
    .globl sakum_kw_count
    .globl sakum_kw_lookup
    .globl sakum_kw_category
    .globl sakum_kw_name
    .globl sakum_kw_mean
    .globl main
    .balign 8
